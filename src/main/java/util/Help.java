...
public class Help {
	...
	public final static String HELPTEXT = "\n>>> Ich verstehe folgende Befehle (NICHT case sensitive):\n"
			...
			+ "`MegFollow Channel-Name oder Snowflake`: Erhalte Benachrichtigungen, wenn jemand einem VoiceChannel beitritt (auf dem entsprechendem Server ausführen!)\n"
			...
			+ "`MegKatakana TEXT`: Lateinisches Alphabet -> Katakana :abc: --> :sa:\n"
	...
	public final static String MUSICHELPTEXT = "\n>>> Du möchtest deine Freunde mit deiner furchtbaren Musik nerven? Ich helfe dir dabei! :musical_note:\n\n"
			...
			+ "\n"
			+ "`MegPause`: Pausiere die Musik! :pause_button:"
			+ "\n"
			+ "`MegPlay`: Antipausiere die Musik! :arrow_forward:"
			+ "\n"
			+ "`MegStop`: Beende die Musikwiedergabe und lösche die Warteschlange :stop_button:"
			+ "\n"
